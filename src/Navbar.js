      ...
      <div className='flex gap-5 justify-start items-end ml-6'>
        ...
        <a href="https://www.facebook.com/"  target="_blank" rel="noreferrer">
          <div className='flex flex-col items-center gap-2'>
            <img src={process.env.PUBLIC_URL+'/images/open_v2/fbmsgicon.png'} alt="" className='w-[26px] lg:w-[40px] transition-all duration-500'/>
            <div className=' tracking-widest text-[#223553] font-bold hidden md:block'>FB諮詢</div>
          </div>
        </a>
